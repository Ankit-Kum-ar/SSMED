    ...
    <div className="navbar bg-base-100 shadow-sm md:px-10">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow text-[#004D40]"
          >
            <li>
              <Link to="/">Home</Link>
            </li>
      ...
      <div className="navbar-end hidden lg:flex">
        <ul className="menu menu-horizontal px-1 text-[#004D40]">
          <li>
